    ...
    .on('connect', socket => {
        ...
        ;(async () => {
            try {
                ...
                if (socket.decoded.role === 'BoothRepresentativePlayer' || socket.decoded.role === 'ReceptionPlayer') {
        ...
        socket.on('getAllUser', async (query = {}) => {
            ...
            io.emit('getAllUserDetails', await userHelper.getUsersBySpecificProjection(filter, ['userId', 'userName', 'location']))
        })
