...
const RESPONSE_ERRORS = {
    ...
    INVALID_USER_ABOUT_FIELD: {
        ...
        MESSAGE: `A user about field should be in the range from ${CONSTANTS.USER_ABOUT_MIN_LIMIT_EXCLUSIVE + 1} to ${CONSTANTS.USER_ABOUT_MAX_LIMIT_INCLUSIVE}`
    },
    ...
    INCOMPLETE_PHONE_DETAILS_GIVEN: {
        ...
        MESSAGE: 'All phone details are required (phoneNumber, phoneCode, phoneCountryCode)'
    },
    NO_USER_FOUND: {
        CODE: 'NO_USER_FOUND',
    ...
    UNCONFIGURED_NAME: {
        ...
        MESSAGE: 'This Error indicates an ENS name was used, but the name has not been configured.'
    },
    OFFCHAIN_FAULT: {
        CODE: 'OFFCHAIN_FAULT',
        MESSAGE: 'A CCIP-read exception, which cannot be recovered from or be further processed.'
    },
    BLOCKCHAIN_ERROR: {
    ...
    INVALID_EXPIRY_DATE: {
        ...
        MESSAGE: 'Invalid expiry date, expiry date should be greater than the current date'
    },
    // Quest Errors
    ...
    CANT_UPDATE_THIS_AGREEMENT_DUE_TO_THIS_AGREEMENT_IS_NOT_IN_PENDING_STATE: {
        ...
        MESSAGE: 'Cant update this agreement due to this agreement is not in pending state'
    },
    ...
    CANT_UPDATE_THIS_AGREEMENT_DUE_TO_THIS_AGREEMENT_IS_NOT_FAMILY_MODE: {
        ...
        MESSAGE: 'Cant update this agreement due to this agreement is not family mode.'
    },
    ...
    CANNOT_PARTICIPATE_IN_THIS_QUEST: {
        ...
        MESSAGE: 'The quest has either started or finished so a user cannot participate'
    },
    CANNOT_PARTICIPATE_AS_QUEST_OVERLAP: {
        CODE: 'CANNOT_PARTICIPATE_AS_QUEST_OVERLAP',
        MESSAGE: 'The user cannot participate in this quest as it overlaps with another quest the user is currently engaged in'
    },
    CANNOT_CREATE_AN_AGREEMENT_AS_QUEST_OVERLAP: {
        CODE: 'CANNOT_CREATE_AN_AGREEMENT_AS_QUEST_OVERLAP',
        MESSAGE: 'The user cannot create an agreement in this quest as it overlaps with another quest the user is currently engaged in'
    },
    CANNOT_CREATE_AN_AGREEMENT_FOR_THIS_REMOTE_PLAYER_AS_QUEST_OVERLAP: {
        ...
        MESSAGE: 'Cannot create an agreement for the remote player selected as this quest overlaps with another quest the user is currently engaged in'
    },
    ...
    CANNOT_CREATE_AN_AGREEMENT_FOR_THIS_FAMILY_PLAYER_AS_QUEST_OVERLAP: {
        ...
        MESSAGE: 'Cannot create an agreement for the family player selected as this quest overlaps with another quest the user is currently engaged in'
    },

    CANNOT_CREATE_AGREEMENT_FOR_THIS_QUEST: {
        CODE: 'CANNOT_CREATE_AGREEMENT_FOR_THIS_QUEST',
        MESSAGE: 'The quest has either started or finished so a user cannot create a new agreement'
    },
    ...
    CANNOT_SIGN_AGREEMENT_FOR_THIS_QUEST: {
        ...
        MESSAGE: 'The quest has either started or finished so a user cannot sign any agreement now'
    },
